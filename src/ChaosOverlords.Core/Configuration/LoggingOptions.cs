...
public sealed class LoggingOptions
{
    ...
    /// <summary>
    ///     Maximum number of log files to keep in the log directory. Older files beyond this count will be deleted on startup.
    ///     Set to 0 to disable retention trimming.
    /// </summary>
