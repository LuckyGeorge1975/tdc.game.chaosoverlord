...
/// <summary>
///     Represents a full set of gang-relevant stats that can be combined from different sources (base data, level perks,
///     items).
/// </summary>
    ...
    int MartialArts)
{
    ...
    public static StatSheet From(GangData data)
    {
    ...
    public static StatSheet From(ItemData data)
    {
        return new StatSheet(
            data.Combat,
            data.Defense,
    ...
    public static StatSheet operator +(StatSheet left, StatSheet right)
    {
        return new StatSheet(
